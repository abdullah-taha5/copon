<div class="card">
    <div class="card-header">
        <div class="row">
            <div class="col-lg-8">
                @can('course_create')
                <a href="{{ route('admin.lessons.create') }}" class="btn btn-success ml-3">
                        ...
                        <tr>
                            ...
                            <td class="text-center">
                                <div class="flex justify-center">
                                    @can('lesson_show')
                                        <a class="btn btn-sm btn-primary mr-2" href="{{ route('admin.lessons.show', $lesson) }}">
                                            {{ trans('global.view') }}
                                        </a>
                                    @endcan
                                    @can('lesson_edit')
                                    ...
                                    @endcan
                                    @can('lesson_delete')
                                        <button class="btn btn-sm btn-danger mr-2" type="button" wire:click="confirm('delete', {{ $lesson->id }})" wire:loading.attr="disabled">
                                            {{ trans('global.delete') }}
                                        </button>
                                    @endcan
                                </div>
