    ...
    <div class="card">
        <div class="card-body">
            ...
            <form action="<?php echo e(route('admin.users.store')); ?>" method="POST" enctype="multipart/form-data">
                <?php echo csrf_field(); ?>
                <div class="form-group  mb-3<?php echo e($errors->has('user.name') ? 'invalid' : ''); ?>">
                ...
                <div class="form-group mb-3 <?php echo e($errors->has('user.email') ? 'invalid' : ''); ?>">
                ...
                <div class="form-group mb-3 <?php echo e($errors->has('user.password') ? 'invalid' : ''); ?>">
                    <label class="form-label required" for="password"><?php echo e(trans('cruds.user.fields.password')); ?></label>
                ...
                <div class="form-group mb-3 <?php echo e($errors->has('roles') ? 'invalid' : ''); ?>">
                    ...
                    <select class="select2 form-control" name="roles[]">
                        <?php $__currentLoopData = $options; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option <?php echo e(old('roles') == $key ? 'selected' : ''); ?> value="<?php echo e($key); ?>">
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/omar/omar/Marketopia/coupon-demo/resources/views/admin/user/create.blade.php ENDPATH**/ ?>