...
<div class="row">
    <div class="col-lg-9">
        ...
        <?php endif; ?>
        <form action="<?php echo e(route('admin.courses.store')); ?>" method="POST" class="pt-3" enctype="multipart/form-data">
            <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/omar/omar/Marketopia/copon/resources/views/admin/course/create.blade.php ENDPATH**/ ?>