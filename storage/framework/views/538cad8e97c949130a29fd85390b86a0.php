...
} elseif ($_instance->childHasBeenRendered('l2869823651-0')) {
    $componentId = $_instance->getRenderedChildComponentId('l2869823651-0');
    $componentTag = $_instance->getRenderedChildComponentTagName('l2869823651-0');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('l2869823651-0');
} else {
    $response = \Livewire\Livewire::mount('excel-export', ['model' => 'Course','format' => 'csv']);
    $html = $response->html();
    $_instance->logRenderedChild('l2869823651-0', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                <?php
...
} elseif ($_instance->childHasBeenRendered('l2869823651-1')) {
    $componentId = $_instance->getRenderedChildComponentId('l2869823651-1');
    $componentTag = $_instance->getRenderedChildComponentTagName('l2869823651-1');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('l2869823651-1');
} else {
    $response = \Livewire\Livewire::mount('excel-export', ['model' => 'Course','format' => 'xlsx']);
    $html = $response->html();
    $_instance->logRenderedChild('l2869823651-1', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                <?php
...
} elseif ($_instance->childHasBeenRendered('l2869823651-2')) {
    $componentId = $_instance->getRenderedChildComponentId('l2869823651-2');
    $componentTag = $_instance->getRenderedChildComponentTagName('l2869823651-2');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('l2869823651-2');
} else {
    $response = \Livewire\Livewire::mount('excel-export', ['model' => 'Course','format' => 'pdf']);
    $html = $response->html();
    $_instance->logRenderedChild('l2869823651-2', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                <?php endif; ?>
...
<?php $__env->stopPush(); ?><?php /**PATH /home/omar/omar/Marketopia/copon/resources/views/livewire/course/index.blade.php ENDPATH**/ ?>