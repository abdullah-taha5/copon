<?php $__env->startSection('content'); ?>
    ...
    <div class="row">
        <div class="col-lg-9">
            ...
            <?php endif; ?>
            <form action="<?php echo e(route('admin.lessons.store')); ?>" method="POST" enctype="multipart/form-data">
                <?php echo csrf_field(); ?>
                    ...
                    <div class="tab-content">
                        <div class="tab-pane fade show active" id="ar-lang" role="tabpanel">
                            ...
                            <div class="form-group mb-2 <?php echo e($errors->has('short_text_ar') ? 'invalid' : ''); ?>">
                                ...
                                <textarea class="form-control" name="short_text_ar" id="short_text_ar" required rows="4"><?php echo e(old('short_text_ar')); ?></textarea>
                                <div class="validation-message">
                            ...
                            <div class="form-group mb-2 <?php echo e($errors->has('long_text_ar') ? 'invalid' : ''); ?>">
                                ...
                                <textarea class="form-control" name="long_text_ar" id="long_text_ar" required rows="6"><?php echo e(old('long_text_ar')); ?></textarea>
                                <div class="validation-message">
                        ...
                        <div class="tab-pane fade" id="en-lang" role="tabpanel">
                            ...
                            <div class="form-group mb-2 <?php echo e($errors->has('short_text_en') ? 'invalid' : ''); ?>">
                                ...
                                <textarea class="form-control" name="short_text_en" id="short_text_en" required rows="4"><?php echo e(old('short_text_en')); ?></textarea>
                                <div class="validation-message">
                            ...
                            <div class="form-group mb-2 <?php echo e($errors->has('long_text_en') ? 'invalid' : ''); ?>">
                                ...
                                <textarea class="form-control" name="long_text_en" id="long_text_en" required rows="6"><?php echo e(old('long_text_en')); ?></textarea>
                                <div class="validation-message">
                ...
                <div class="card mt-3">
                    <div class="card-body">
                        ...
                        <div class="form-group <?php echo e($errors->has('iframe') ? 'invalid' : ''); ?>">
                            ...
                            <textarea class="form-control" name="iframe" id="iframe" rows="4"><?php echo e(old('iframe')); ?></textarea>
                            <div class="validation-message">
                        ...
                        <div class="form-group <?php echo e($errors->has('position') ? 'invalid' : ''); ?>">
                            ...
                            <input class="form-control" type="number" name="position" id="position"
                                value="<?php echo e(old('position')); ?>" step="1">
                            <div class="validation-message">
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/omar/omar/Marketopia/coupon-demo/resources/views/admin/lesson/create.blade.php ENDPATH**/ ?>