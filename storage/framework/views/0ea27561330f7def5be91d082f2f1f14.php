...
} elseif ($_instance->childHasBeenRendered('l3103881156-0')) {
    $componentId = $_instance->getRenderedChildComponentId('l3103881156-0');
    $componentTag = $_instance->getRenderedChildComponentTagName('l3103881156-0');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('l3103881156-0');
} else {
    $response = \Livewire\Livewire::mount('excel-export', ['model' => 'User','format' => 'csv']);
    $html = $response->html();
    $_instance->logRenderedChild('l3103881156-0', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                <?php
...
} elseif ($_instance->childHasBeenRendered('l3103881156-1')) {
    $componentId = $_instance->getRenderedChildComponentId('l3103881156-1');
    $componentTag = $_instance->getRenderedChildComponentTagName('l3103881156-1');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('l3103881156-1');
} else {
    $response = \Livewire\Livewire::mount('excel-export', ['model' => 'User','format' => 'xlsx']);
    $html = $response->html();
    $_instance->logRenderedChild('l3103881156-1', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                <?php
...
} elseif ($_instance->childHasBeenRendered('l3103881156-2')) {
    $componentId = $_instance->getRenderedChildComponentId('l3103881156-2');
    $componentTag = $_instance->getRenderedChildComponentTagName('l3103881156-2');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('l3103881156-2');
} else {
    $response = \Livewire\Livewire::mount('excel-export', ['model' => 'User','format' => 'pdf']);
    $html = $response->html();
    $_instance->logRenderedChild('l3103881156-2', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                <?php endif; ?>
...
<?php /**PATH /home/omar/omar/Marketopia/copon/resources/views/livewire/user/index.blade.php ENDPATH**/ ?>