<?php $__env->startSection('content'); ?>
    ...
    <form action="<?php echo e(route('admin.roles.update', $role)); ?>" method="POST" class="pt-3">
        <?php echo csrf_field(); ?>
        ...
        <div class="form-group <?php echo e($errors->has('title') ? 'invalid' : ''); ?>">
            ...
            <input class="form-control" type="text" name="title" id="title" required value="<?php echo e($role->title); ?>">
        ...
        <div class="form-group <?php echo e($errors->has('permissions') ? 'invalid' : ''); ?>">
            ...
            <select id="select2Basic" class="select2 form-select form-select-lg" name="permissions[]" data-allow-clear="true" multiple>
                <?php $__currentLoopData = $permissions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <option value="<?php echo e($key); ?>" <?php echo e(in_array($key, $selected) ? 'selected' : ''); ?>><?php echo e($value); ?></option>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/omar/omar/Marketopia/coupon-demo/resources/views/admin/role/edit.blade.php ENDPATH**/ ?>